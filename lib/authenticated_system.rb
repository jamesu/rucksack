module AuthenticatedSystem
  protected
    ...
    # Preloads @logged_user with the user model if they're logged in.
    def logged_in?
      !!current_user
    end
    ...
    def valid_remember_cookie?
      return nil unless @logged_user
      (@logged_user.remember_token?) && 
        (cookies[:auth_token] == @logged_user.remember_token)
    end
    ...
    def handle_remember_cookie!(new_cookie_flag)
      ...
      case
      when valid_remember_cookie? then @logged_user.refresh_token # keeping same expiry date
      when new_cookie_flag        then @logged_user.remember_me 
      else                             @logged_user.forget_me
      end
